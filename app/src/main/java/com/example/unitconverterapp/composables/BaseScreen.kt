...
import com.example.unitconverterapp.composables.converter.TopScreen
    ...
    when(configuration.orientation){
        Configuration.ORIENTATION_LANDSCAPE ->{
            ...
            Row(
                ...
                TopScreen(conversionList, converterViewModel.selectedConversion, converterViewModel.inputText, converterViewModel.inputVal, isLandscape){ message1, message2 ->
